...
public class HuodongBaomingView extends HuodongBaomingEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 评定结果的值
		*/
		private String huodongBaomingPingdingValue;
	...
	public HuodongBaomingView(HuodongBaomingEntity huodongBaomingEntity) {
		try {
			...
			* 获取： 评定结果的值
			*/
			public String getHuodongBaomingPingdingValue() {
				return huodongBaomingPingdingValue;
			}
			/**
			* 设置： 评定结果的值
			*/
			public void setHuodongBaomingPingdingValue(String huodongBaomingPingdingValue) {
				this.huodongBaomingPingdingValue = huodongBaomingPingdingValue;
			}
