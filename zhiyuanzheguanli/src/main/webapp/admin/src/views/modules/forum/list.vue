            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.zhiyuanzheId">
                            志愿者
                        </span>
                        <span v-if="scope.row.huodongchengbanfangId">
                            活动承办方
                        </span>
                        <span v-if="scope.row.tuanweiId">
                            团委
                        </span>
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '团委名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.tuanweiName" placeholder="团委名称" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/zhiyuanzheguanli/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <span v-if="scope.row.tuanweiId">
                                <div v-if="scope.row.tuanweiPhoto">
                                    <img :src="scope.row.tuanweiPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.usersId">
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.tuanweiName!= '' && this.searchForm.tuanweiName!= undefined) {
                    params['tuanweiName'] = '%' + this.searchForm.tuanweiName + '%'
                }
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.zhiyuanzheId = el.zhiyuanzheId;//---
                            forum.zhiyuanzheName = el.zhiyuanzheName;
                            forum.zhiyuanzhePhone = el.zhiyuanzhePhone;
                            forum.zhiyuanzheIdNumber = el.zhiyuanzheIdNumber;
                            forum.zhiyuanzhePhoto = el.zhiyuanzhePhoto;
                            forum.zhiyuanzheEmail = el.zhiyuanzheEmail;
                            forum.createTime = el.createTime;
                            forum.huodongchengbanfangId = el.huodongchengbanfangId;//---
                            forum.huodongchengbanfangName = el.huodongchengbanfangName;
                            forum.huodongchengbanfangTypes = el.huodongchengbanfangTypes;
                            forum.huodongchengbanfangPhone = el.huodongchengbanfangPhone;
                            forum.huodongchengbanfangPhoto = el.huodongchengbanfangPhoto;
                            forum.huodongchengbanfangContent = el.huodongchengbanfangContent;
                            forum.createTime = el.createTime;
                            forum.tuanweiId = el.tuanweiId;//---
                            forum.tuanweiName = el.tuanweiName;
                            forum.createTime = el.createTime;
